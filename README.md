...
- [ ] Mention two parts of Express that you learned about this week.
        - using scripts to start a server and using 'require' to import files 

- [ ] Describe Middleware?
        - middleware is a function that handles an action in an app

- [ ] Describe a Resource?
        - typically it is a set of data that is stored and accessible through the API
